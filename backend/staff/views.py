...
from backend.staff.serializers import StaffSerializer, StaffTimesheetSerializer
...
class StaffTimesheetViewSet(ModelViewSet):
    ...
    serializer_class = StaffTimesheetSerializer
    permission_classes = [IsAuthenticated]
...
"""TODO: add support for date selection for staff shifts"""
