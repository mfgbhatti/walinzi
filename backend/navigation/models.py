...
class Navigation(models.Model):
    ...
    parent = models.ForeignKey("self", blank=True, on_delete=models.CASCADE, default="", null=True, related_name="children")
    visible_to = models.ForeignKey(Group, blank=True, default="",null=True, on_delete=models.DO_NOTHING)
