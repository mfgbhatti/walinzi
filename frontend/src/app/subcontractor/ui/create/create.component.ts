...
export class CreateSubcontractorComponent {
  ...
  constructor(
    ...
    public readonly dialogRef: MatDialogRef<CreateSubcontractorComponent>,
    @Inject(MAT_DIALOG_DATA) private readonly data: Subcontractor
  ) { }
  ...
  setForm() {
    this.form = this.formbuilder.group({
      ...
      pay_rate: [this.data.pay_rate, [Validators.required, Validators.min(0)]],
